...
const features = [
    ...
    },
    {
        ...
        description:
            "Visualize seus lucros e performance de vendas em tempo real",
    },
    {
        icon: Shield,
        title: "Dados Seguros",
            ...
            <nav className="border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xl font-bold">MyPurchase</span>
                    </div>
            ...
            <section className="py-20 px-4">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                        Controle total sobre seus produtos comprados e vendidos.
                        Acompanhe lucros, organize estoque e maximize seus
                        resultados.
                    </p>
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Recursos poderosos para transformar sua gestão de
                            produtos
                        </p>
                    </div>
            ...
            <section className="py-20 px-4 bg-muted/20">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                        Junte-se a milhares de pessoas que já otimizaram seus
                        negócios
                    </p>
            ...
            <footer className="border-t border-border/40 py-8 px-4">
                <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
                    <div className="flex items-center space-x-2 mb-4 md:mb-0">
                        ...
                        <span className="font-semibold">MyPurchase</span>
                    </div>
