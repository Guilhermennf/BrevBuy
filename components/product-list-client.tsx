...
// Converter para o tipo que o ProductActions espera
...
export function ProductListClient({ filters }: ProductListClientProps) {
    ...
    // Converter produto para o tipo que ProductActions espera
    const convertProductForActions = (
        product: ProductFromAPI
    ): ProductForActions => ({
        ...product,
        createdAt: new Date(product.createdAt),
        updatedAt: new Date(product.updatedAt),
        soldAt: product.soldAt ? new Date(product.soldAt) : null,
    });
                    ...
                    <CardContent className="p-0">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-shrink-0">
                                <ProductActions
                                    product={convertProductForActions(product)}
                                />
                            </div>
                        </div>
                    </CardContent>
