...
export function ProductAutomation({ onSuccess }: ProductAutomationProps) {
    ...
    try {
      ...
      if (result.success) {
        ...
        const extractedProduct: ProductData = {
          ...
          imageUrl: uploadedImage.preview, // Usar a imagem carregada
  ...
  const handleSaveProduct = () => {
    ...
    uploadImageMutation.mutate(imageToUse, {
      onSuccess: (imageUrl) => {
        // Após upload da imagem, criar o produto
        createProductMutation.mutate(
          {
            name: extractedData.title.trim(),
            description: extractedData.description.trim() || "",
            buyPrice: extractedData.price,
            imageUrl: imageUrl.imageUrl,
            categoryId: extractedData.categoryId,
            supplier: "Registrado pela IA",
          },
          {
            onSuccess: () => {
              toast({
                title: "Produto adicionado com sucesso!",
                description: `${extractedData.title} foi adicionado ao seu estoque.`,
              });
