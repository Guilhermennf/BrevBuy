...
export function ProductAutomation({ onSuccess }: ProductAutomationProps) {
    const [extractedData, setExtractedData] = useState<ProductData | null>(
        null
    );
    ...
    const analyzeImageWithAI = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                const matchedCategoryId = findSimilarCategory(
        ...
        if (imageItem) {
            ...
            if (file) {
                ...
                toast({
                    ...
                    description:
                        "Imagem carregada! Clique em 'Analisar' para processar.",
                });
            }
        }
    };
    ...
    const handleSaveProduct = () => {
        if (
            ...
            toast({
                ...
                description:
                    "Preencha pelo menos o nome e selecione uma categoria.",
                variant: "destructive",
            });
            return;
        }
        ...
        formData.append("supplier", extractedData.supplier.trim() || "");
        ...
        <div className="h-full max-h-[70vh] overflow-y-auto space-y-4 pr-2">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Faça upload de qualquer imagem de produto e deixe a IA
                        extrair as informações automaticamente
                    </CardDescription>
                </CardHeader>
                                ...
                                <CardContent className="p-4">
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-xs text-muted-foreground text-center">
                                            A IA extrairá automaticamente: nome,
                                            preço, descrição e categoria
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <>
                                ...
                                >
                                    ...
                                    <DialogContent>
                                        <DialogHeader>
                                            <DialogTitle>
                                                Analisar Screenshot do
                                                AliExpress
                                            </DialogTitle>
                                            <DialogDescription>
                                                Selecione uma captura de tela da
                                                página do produto
                                            </DialogDescription>
                                        </DialogHeader>
                                        <div className="space-y-4">
                    ...
                    {extractedData && (
                        <Card className="mt-4 border-green-200">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Revise e edite as informações antes de
                        ...
                        `}
                                                onDragEnter={
                                                    handleProductImageDragEnter
                                                }
                                                onDragLeave={
                                                    handleProductImageDragLeave
                                                }
                                                onDragOver={
                                                    handleProductImageDragOver
                                                }
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            Múltiplas unidades serão criadas se{" "}
                                            {">"} 1
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="border-t pt-4 ">
                                    <div className="flex justify-between items-center gap-4">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Você pode editar qualquer
                                                informação antes de salvar
                                            </p>
                                        </div>
